...
def fase1():
    ...
    escrever_lentamente("\nVocê é uma investigadora conhecida apenas como Samanta, uma mulher de passado nebuloso e com fama de resolver casos impossíveis. Você não é considerada uma nobre, mas também não é uma plebéia. Suas memórias estão fragmentadas, sua cabeça lateja com uma dor intensa e seu corpo, ainda que forte, parece envolto em uma névoa de cansaço e fadiga.")
    time.sleep(3)
    os.system("cls")
    
    escrever_lentamente("Samanta estava sentada à sombra de um velho carvalho quando a chamaram. Uma jovem aldeã com olhos preocupados segurava o manto de lã com força, fitando-a com desconfiança. Ela sabe quem Samanta era. O sol já se escondia entre as colinas, lançando uma luz alaranjada sobre os campos. ")
    escrever_lentamente("\n— Preciso que venha comigo... há algo que precisa ver — disse a jovem, quase em um sussurro. Ela parecia assusstada.")
    escrever_lentamente("\nA dor na cabeça de Samanta, que a acompanhava desde que ela acordou nos campos aquele dia, latejou novamente. Ela olhou para a jovem e assentiu, ignorando o desconforto. Ambas caminharam em silêncio até a velha estalagem 'O Corvo e a Espada', um lugar mal-afamado, onde poucos nobres ousavam pisar.")
    escrever_lentamente("\nAssim que ambas cruzaram a soleira, o cheiro de sangue atingiu Samanta como um golpe. No centro do salão estava o corpo: Baldwin, o Ferreiro, um velho conhecido dela, ainda que não exatamente próximo. Ele jazia no chão, com um corte profundo no peito e marcas de luta pelos braços e rosto. A morte parecia recente. Samanta se abaixou para observar os detalhes, já sabendo o motivo de eles desejaram a presença dela ali: eles queriam que ela descobrisse quem o matou e, se possível, o motivo disso. Samanta observou, vagamente, os arredores da estalagem que, de tempos em tempos, visitava. Era como se cada canto da estalagem, cada sombra, guardasse um fragmento esquecido de seu próprio passado.")
    escrever_lentamente("\nEnquanto analisava a cena, Samanta encontrou cinco pistas principais:")
