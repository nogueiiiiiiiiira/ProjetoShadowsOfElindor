...
import time
import os
from game.interacoes import interrogar1, interrogar2, interrogar3, interrogar4, interrogar5
from game.utils import escreverLentamente, mostrarImagem, limparConsole
...
def fase1():
    limparConsole()
    escreverLentamente("    No reino de Elindor, uma pequena vila medieval é abalada por um assassinato brutal. No coração da vila, em uma estalagem afastada e de má fama, um corpo foi encontrado, sem vida e envolto em mistérios. ", espacosEsquerda = 4)
    ...
    mostrarImagem("../data/samanta.webp")
    time.sleep(3)
    limparConsole()
    
    escreverLentamente("    Samanta estava sentada à sombra de um velho carvalho quando a chamaram. Uma jovem aldeã com olhos preocupados segurava o manto de lã com força, fitando-a com desconfiança. Ela sabia quem Samanta era. ", espacosEsquerda = 4)
    ...
    escreverLentamente("     Uma investigação em torno da faca será o primeiro passo que Samanta tomará. Dentre os suspeitos que ela já reuniu pistas, somente dois podem ser ligados à lâmica: Isolde, a Cozinheira, Calistus, o Caçador. ", espacosEsquerda = 4)
    time.sleep(3)
    limparConsole()
    interrogar1()
    pass 
...
def fase4():
    limparConsole()
    escreverLentamente("     Após conversar com Madame Morgana, que é fria e altiva em suas respostas, Samanta decide seguir adiante com suas investigações. ", espacosEsquerda = 4)
