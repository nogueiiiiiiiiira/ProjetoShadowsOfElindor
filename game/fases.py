...
def fase1():
    ...
    escrever_lentamente("\nAssim que ambas cruzaram a soleira, o cheiro de sangue atingiu Samanta como um golpe. No centro do salão estava o corpo: Baldwin, o Ferreiro, um velho conhecido dela, ainda que não exatamente próximo. Ele jazia no chão, com um corte profundo no peito e marcas de luta pelos braços e rosto. Samanta se abaixou para observar os detalhes, já sabendo o motivo de eles desejaram a presença dela ali: eles queriam que ela descobrisse quem o matou e, se possível, o motivo disso. Samanta observou, vagamente, os arredores da estalagem que, de tempos em tempos, visitava. Era como se cada canto da estalagem, cada sombra, guardasse um fragmento esquecido de seu próprio passado.")
